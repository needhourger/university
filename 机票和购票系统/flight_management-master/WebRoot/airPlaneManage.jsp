          ...
          <div class="table-responsive">
			...
			<c:forEach var="a" items="${airPlanesList}">
				 <tr>
                  ...
                  <td>
                  	<button type="button" class="btn btn-xs btn-danger" onclick="javascript:if(confirm('确实要删除吗?'))window.location.href='servlet/DeleteAirPlaneServlet?airPlaneNo=${a.no}';">删除</button>
                  </td>
                </tr>
			</c:forEach>
