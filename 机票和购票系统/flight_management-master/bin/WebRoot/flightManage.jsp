			...
			<c:forEach var="f" items="${flightList}">
				 <tr>
                  ...
                  <td>
                  	...
                  	<button type="button" class="btn btn-xs btn-danger" onclick="javascript:if(confirm('确实要删除吗?'))window.location.href='servlet/DeleteFlightServlet?flightNo=${f.no}';">删除</button>
                  </td>
                </tr>
			</c:forEach>
